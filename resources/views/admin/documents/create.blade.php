...
<div style="background: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); max-width: 900px; margin: 0 auto;">
    ...
    <form action="{{ route('admin.documents.store') }}" method="POST" enctype="multipart/form-data" style="font-family: 'Segoe UI', sans-serif;">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="text" name="title" id="title" required placeholder="VD: Tiêu chuẩn thi công cọc khoan nhồi"
        ...
        <div style="margin-bottom: 20px;">
            ...
            <select name="category" id="category" required
                ...
                <option value="tieu-chuan-thi-cong">Tiêu chuẩn thi công</option>
                <option value="tieu-chuan-thi-nghiem">Tiêu chuẩn thí nghiệm</option>
                <option value="excel-ung-dung">Excel - Ứng dụng</option>
            </select>
